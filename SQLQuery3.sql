/*
Скрипт развертывания для Emp_Dep
...
GO
:setvar DatabaseName "Emp_Dep"
:setvar DefaultFilePrefix "Emp_Dep"
...
BEGIN TRANSACTION
GO
PRINT N'Выполняется создание [dbo].[DepTable]...';


GO
CREATE TABLE [dbo].[DepTable] (
    [Id]      INT           NOT NULL,
    [NameDep] NVARCHAR (50) NOT NULL,
